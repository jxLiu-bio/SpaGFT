...
simultaneously. _SpaGFT_ can detect spatially variable genes, identify tissue 
modules, impute gene expression.
...
- Running efficiently. _SpaGFT_ can run on PCs directly and is running fast. For 
