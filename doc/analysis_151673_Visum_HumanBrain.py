...
# Define data path
data_dir = "./datasets/"
sample = "151673_Visum_HumanBrain"
...
## low FMs
for i in range(1, 3):
    spg.plot.visualize_fms(adata, rank=i, size=3, coord_ratio=0.7)
## high FMs
for i in range(1, 3):
    spg.plot.visualize_fms(adata, rank=i, low=False, size=3, coord_ratio=0.7)
